...
SECRET_KEY = 'django-insecure-^j%)71m@mv@0r2t%tmst-%+#)4&2nmly9o6iccduii5+%xfbc_'
...
# Trust Azure App Service domain for CSRF
...
# Use DATABASE_URL if provided (Docker setup with PostgreSQL)
